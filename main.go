...
func main() {
	...
	commands.Register("reset", handlers.HandlerResetUsers)
	...
	commands.Register("follow", handlers.HandlerCreateFeedFollows)
	commands.Register("following", handlers.HandlerGetFeedFollows)
